...
module "enterprise_scale" {
  ...
  custom_landing_zones = {
    "${var.root_id}-online-example-1" = {
      ...
      parent_management_group_id = "${var.root_id}-landing-zone"
      subscription_ids           = []
      archetype_config = {
      ...
      archetype_config = {
        ...
        parameters     = {
          Deny-Resource-Locations = {
            listOfAllowedLocations = ["norwayeast",]
          }
          Deny-RSG-Locations = {
            listOfAllowedLocations = ["norwayeast",]
          }
    ...
    "${var.root_id}-online-example-3" = {
      display_name               = "${upper(var.root_id)} Online Example 3"
      parent_management_group_id = "${var.root_id}-landing-zone"
      subscription_ids           = []
      archetype_config = {
        archetype_id   = "customer_online"
